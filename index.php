			...
			<div class="col-md-12 no-padding">
				<div class="hero_img">
					...
					<div class="page_title text-xs-center">
						...
						<a href="#" class="my-btn">Заказать консультацию организатора событий</a>
					</div>
				</div>
			</div>
		</div>
...
<div class="container">
		...
		<div class="container">
			...
			<div class="container">
				...
				<div class="bnt-container">
					<div class="row">
						<div class="col-md-6">
							<a href="#" class="my-btn simple">Заказать персональную консультацию <br> о всех оказываемых
								услугах</a>
						</div>
						<div class="col-md-6">
			...
			<div class="col-md-7">
				<div class="planing-text">
					...
					<div class="planing-content">
						<p> Выбор ресторана - лишь начало подготовки торжественного банкета, ведь его организация подразумевает контроль очень многих вопросов, которые для виновников торжества всегда остаются за кадром и известны лишь опытному организатору. </p>
	...
	<section id="form" class="arr_top border">
		<div class="row">
			<div class="col-md-12">
				<h3 class="form-title text-md-center">Анна, свяжитесь со мной и мы обсудим моё торжество</h3>
			</div>
		</div>
		<form class="form-horizontal">
			<div class="row">
				<div class="col-md-10 offset-md-1">
					<div class="form-group clearfix">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" id="inputEmail3" placeholder="Имя и фамилия *">
						</div>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-10 offset-md-1">
					<div class="form-group clearfix">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" id="inputPassword3" placeholder="Номер телефона *">
						</div>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-10 offset-md-1">
					<div class="form-group clearfix">
						<label for="inputPassword3" class="col-sm-3 control-label">Примечания</label>
						<div class="col-sm-8">
			...
			<div class="form-group text-md-center">
				...
				<!--<button type="submit" class="my-btn">Отправить запрос</button>-->
			</div>
		</form>
