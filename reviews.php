...
<section id="reviews" class="arr_top">
	<div class="row">
		<ul class="btn-block clearfix tabs" role="tablist">
			...
			<li class="nav-item col-xs-4">
				<a class="tab my-btn ghost" data-toggle="tab" href="#sapphire" role="tab">Театр песни "Сапфир"</a>
			</li>
			<li class="nav-item col-xs-4">
							...
							<div class="invert">
								<div class="col-md-6 right">
									<div class="review-content">
										...
										<div class="review-text">
											<p>Довольно сложно подобрать слова, которыми было бы возможно отблагодарить
												Вас за
												все.
												Знаем, что порой мы были очень придирчивы и сами не знали чего же
												хотим... И мы
											...
											<p>
												Благодаря всем Вам наш счастливый день навсегда останется в наших
												сердцах как
												яркое
												и
											...
											<p>
												Желаем Вам процветания и благополучия! Вы дарите людям улыбки и
												радость!</p>
											<p>Желаем вам только процветания, успешных проведенных торжеств, и
												чтобы все молодожены обращались только к вам!!!</p>
										</div>
